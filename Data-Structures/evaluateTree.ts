...
The evaluation of a node is as follows:
    ...
    If the node is a leaf node, the evaluation is 
    the value of the node, i.e. True or False.

    Otherwise, evaluate the node's two children and 
    apply the boolean operation of its value with the children's evaluations.
...
Explanation: The root node is a leaf node and 
it evaluates to false, so we return false.
