...
happiness value happiness[i]. You want to select k children from these n children in k turns.
...
the happiness value cannot become negative and gets decremented only if it is positive.
